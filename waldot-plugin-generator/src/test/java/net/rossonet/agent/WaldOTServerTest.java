...
public class WaldOTServerTest {
	...
	public void run20000GeneratorServer() throws Exception {
		...
		for (int i = 0; i < 20000; i++) {
			g.addVertex(MiloStrategy.ID_PARAMETER, "test" + i, WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(), "random",
					MiloStrategy.LABEL_FIELD.toLowerCase(), "test" + i, MiloStrategy.TYPE_DEFINITION_PARAMETER,
					WaldotGeneratorPlugin.DATA_GENERATOR_OBJECT_TYPE_LABEL, WaldotGeneratorPlugin.DELAY_FIELD.toLowerCase(), "1000");
		}
	...
	public void runAllGeneratorServer() throws Exception {
		...
		for (int i = 0; i < 5000; i++) {
			g.addVertex(MiloStrategy.DIRECTORY_PARAMETER, "random", MiloStrategy.ID_PARAMETER, "random" + i,
					WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(), "random", MiloStrategy.LABEL_FIELD.toLowerCase(),
			...
			g.addVertex(MiloStrategy.DIRECTORY_PARAMETER, "incrmental", MiloStrategy.ID_PARAMETER, "incrmental" + i,
					WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(), "incrmental", MiloStrategy.LABEL_FIELD.toLowerCase(),
			...
			g.addVertex(MiloStrategy.DIRECTORY_PARAMETER, "decremental", MiloStrategy.ID_PARAMETER, "decremental" + i,
					WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(), "decremental", MiloStrategy.LABEL_FIELD.toLowerCase(),
			...
			g.addVertex(MiloStrategy.DIRECTORY_PARAMETER, "sinusoidal", MiloStrategy.ID_PARAMETER, "sinusoidal" + i,
					WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(), "sinusoidal", MiloStrategy.LABEL_FIELD.toLowerCase(),
					"sinusoidal" + i, MiloStrategy.TYPE_DEFINITION_PARAMETER,
					WaldotGeneratorPlugin.DATA_GENERATOR_OBJECT_TYPE_LABEL, WaldotGeneratorPlugin.DELAY_FIELD.toLowerCase(), "5000");
			g.addVertex(MiloStrategy.DIRECTORY_PARAMETER, "triangular", MiloStrategy.ID_PARAMETER, "triangular" + i,
					WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(), "triangular", MiloStrategy.LABEL_FIELD.toLowerCase(),
					"triangular" + i, MiloStrategy.TYPE_DEFINITION_PARAMETER,
					WaldotGeneratorPlugin.DATA_GENERATOR_OBJECT_TYPE_LABEL, WaldotGeneratorPlugin.DELAY_FIELD.toLowerCase(), "8000");
		}
	...
	public void runSimpleGeneratorServer() throws Exception {
		...
		g.addVertex(MiloStrategy.ID_PARAMETER, "test3", MiloStrategy.LABEL_FIELD.toLowerCase(), "test3",
				MiloStrategy.TYPE_DEFINITION_PARAMETER, WaldotGeneratorPlugin.DATA_GENERATOR_OBJECT_TYPE_LABEL,
				WaldotGeneratorPlugin.DELAY_FIELD.toLowerCase(), "400", WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(),
				"decremental", WaldotGeneratorPlugin.MAX_VALUE_FIELD.toLowerCase(), "100",
				WaldotGeneratorPlugin.MIN_VALUE_FIELD.toLowerCase(), "50");
		g.addVertex(MiloStrategy.ID_PARAMETER, "test4", MiloStrategy.LABEL_FIELD.toLowerCase(), "test4",
				MiloStrategy.TYPE_DEFINITION_PARAMETER, WaldotGeneratorPlugin.DATA_GENERATOR_OBJECT_TYPE_LABEL,
				WaldotGeneratorPlugin.DELAY_FIELD.toLowerCase(), "4000", WaldotGeneratorPlugin.ALGORITHM_FIELD.toLowerCase(),
				"random", WaldotGeneratorPlugin.MAX_VALUE_FIELD.toLowerCase(), "-1",
				WaldotGeneratorPlugin.MIN_VALUE_FIELD.toLowerCase(), "-5000");
