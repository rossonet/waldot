...
public class OpcNodeEventPayload implements EventPayload {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeEventPayload other = (OpcNodeEventPayload) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeEventPayload bean.
     */
    public static class Builder extends EventPayloadBuilder<OpcNodeEventPayload, Builder> {
        ...
        @Override
        protected OpcNodeEventPayload newBuildingInstance() {
            return new OpcNodeEventPayload();
        }
    }
}
