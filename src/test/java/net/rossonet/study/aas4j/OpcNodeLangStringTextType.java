...
public class OpcNodeLangStringTextType implements LangStringTextType {
    ...
    public OpcNodeLangStringTextType() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeLangStringTextType other = (OpcNodeLangStringTextType) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeLangStringTextType bean.
     */
    public static class Builder extends LangStringTextTypeBuilder<OpcNodeLangStringTextType, Builder> {
        ...
        @Override
        protected OpcNodeLangStringTextType newBuildingInstance() {
            return new OpcNodeLangStringTextType();
        }
    }
}
