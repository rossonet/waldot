...
public class OpcNodeAssetAdministrationShellDescriptor implements AssetAdministrationShellDescriptor {
    ...
    public OpcNodeAssetAdministrationShellDescriptor() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeAssetAdministrationShellDescriptor other = (OpcNodeAssetAdministrationShellDescriptor) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeAssetAdministrationShellDescriptor (" + "administration=%s,"
                + "assetKind=%s,"
                + "assetType=%s,"
                + "endpoints=%s,"
                + "globalAssetId=%s,"
    ...
    /**
     * This builder class can be used to construct a OpcNodeAssetAdministrationShellDescriptor bean.
     */
    public static class Builder extends AssetAdministrationShellDescriptorBuilder<OpcNodeAssetAdministrationShellDescriptor, Builder> {
        ...
        @Override
        protected OpcNodeAssetAdministrationShellDescriptor newBuildingInstance() {
            return new OpcNodeAssetAdministrationShellDescriptor();
        }
    }
}
