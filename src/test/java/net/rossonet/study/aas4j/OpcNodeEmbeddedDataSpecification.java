...
public class OpcNodeEmbeddedDataSpecification implements EmbeddedDataSpecification {
    ...
    public OpcNodeEmbeddedDataSpecification() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeEmbeddedDataSpecification other = (OpcNodeEmbeddedDataSpecification) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeEmbeddedDataSpecification (" + "dataSpecification=%s,"
    ...
    /**
     * This builder class can be used to construct a OpcNodeEmbeddedDataSpecification bean.
     */
    public static class Builder extends EmbeddedDataSpecificationBuilder<OpcNodeEmbeddedDataSpecification, Builder> {
        ...
        @Override
        protected OpcNodeEmbeddedDataSpecification newBuildingInstance() {
            return new OpcNodeEmbeddedDataSpecification();
        }
    }
}
