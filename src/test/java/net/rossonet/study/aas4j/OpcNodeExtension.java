 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.Extension
 * 
 * Single extension of an element.
 */

@IRI("aas:Extension")
public class OpcNodeExtension implements Extension {

	/**
	 * This builder class can be used to construct a OpcNodeExtension bean.
	 */
	public static class Builder extends ExtensionBuilder<OpcNodeExtension, Builder> {
		...
		@Override
		protected OpcNodeExtension newBuildingInstance() {
			return new OpcNodeExtension();
		}
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeExtension other = (OpcNodeExtension) obj;
			return Objects.equals(this.name, other.name) && Objects.equals(this.valueType, other.valueType)
					&& Objects.equals(this.value, other.value) && Objects.equals(this.refersTo, other.refersTo)
	...
	public String toString() {
		return String.format("OpcNodeExtension (" + "name=%s," + "valueType=%s," + "value=%s," + "refersTo=%s," + ")",
