 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.SubmodelDescriptor
 * 
 */

@IRI("aas:SubmodelDescriptor")
public class OpcNodeSubmodelDescriptor implements SubmodelDescriptor {

	/**
	 * This builder class can be used to construct a OpcNodeSubmodelDescriptor bean.
	 */
	public static class Builder extends SubmodelDescriptorBuilder<OpcNodeSubmodelDescriptor, Builder> {
		...
		@Override
		protected OpcNodeSubmodelDescriptor newBuildingInstance() {
			return new OpcNodeSubmodelDescriptor();
		}
	}
	...
	public OpcNodeSubmodelDescriptor() {
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeSubmodelDescriptor other = (OpcNodeSubmodelDescriptor) obj;
			return Objects.equals(this.administration, other.administration)
					&& Objects.equals(this.endpoints, other.endpoints) && Objects.equals(this.idShort, other.idShort)
					&& Objects.equals(this.id, other.id) && Objects.equals(this.semanticId, other.semanticId)
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.administration, this.endpoints, this.idShort, this.id, this.semanticId,
				this.supplementalSemanticId, this.description, this.displayName, this.extensions);
	}
	...
	public String toString() {
		return String.format(
				"OpcNodeSubmodelDescriptor (" + "administration=%s," + "endpoints=%s," + "idShort=%s," + "id=%s,"
						+ "semanticId=%s," + "supplementalSemanticId=%s," + ")",
				this.administration, this.endpoints, this.idShort, this.id, this.semanticId,
