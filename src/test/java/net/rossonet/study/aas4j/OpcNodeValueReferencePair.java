...
public class OpcNodeValueReferencePair implements ValueReferencePair {
    ...
    public OpcNodeValueReferencePair() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeValueReferencePair other = (OpcNodeValueReferencePair) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeValueReferencePair (" + "value=%s,"
                + "valueId=%s,"
                + ")",
    ...
    /**
     * This builder class can be used to construct a OpcNodeValueReferencePair bean.
     */
    public static class Builder extends ValueReferencePairBuilder<OpcNodeValueReferencePair, Builder> {
        ...
        @Override
        protected OpcNodeValueReferencePair newBuildingInstance() {
            return new OpcNodeValueReferencePair();
        }
    }
}
