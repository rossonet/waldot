...
public class OpcNodeAssetAdministrationShell implements AssetAdministrationShell {
    ...
    public OpcNodeAssetAdministrationShell() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeAssetAdministrationShell other = (OpcNodeAssetAdministrationShell) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeAssetAdministrationShell (" + "derivedFrom=%s,"
                + "assetInformation=%s,"
                + "submodels=%s,"
                + ")",
    ...
    /**
     * This builder class can be used to construct a OpcNodeAssetAdministrationShell bean.
     */
    public static class Builder extends AssetAdministrationShellBuilder<OpcNodeAssetAdministrationShell, Builder> {
        ...
        @Override
        protected OpcNodeAssetAdministrationShell newBuildingInstance() {
            return new OpcNodeAssetAdministrationShell();
        }
    }
}
