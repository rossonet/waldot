...
public class OpcNodeSpecificAssetId implements SpecificAssetId {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeSpecificAssetId other = (OpcNodeSpecificAssetId) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeSpecificAssetId bean.
     */
    public static class Builder extends SpecificAssetIdBuilder<OpcNodeSpecificAssetId, Builder> {
        ...
        @Override
        protected OpcNodeSpecificAssetId newBuildingInstance() {
            return new OpcNodeSpecificAssetId();
        }
    }
}
