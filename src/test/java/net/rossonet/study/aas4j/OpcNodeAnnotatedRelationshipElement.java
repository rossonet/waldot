...
public class OpcNodeAnnotatedRelationshipElement implements AnnotatedRelationshipElement {

	/**
	 * This builder class can be used to construct a
	 * OpcNodeAnnotatedRelationshipElement bean.
	 */
	public static class Builder
			extends AnnotatedRelationshipElementBuilder<OpcNodeAnnotatedRelationshipElement, Builder> {
		...
		@Override
		protected OpcNodeAnnotatedRelationshipElement newBuildingInstance() {
			return new OpcNodeAnnotatedRelationshipElement();
		}
	}
	...
	public OpcNodeAnnotatedRelationshipElement() {
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeAnnotatedRelationshipElement other = (OpcNodeAnnotatedRelationshipElement) obj;
			return Objects.equals(this.annotations, other.annotations) && Objects.equals(this.first, other.first)
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.annotations, this.first, this.second, this.embeddedDataSpecifications, this.category,
				this.idShort, this.displayName, this.description, this.extensions, this.semanticId,
				this.supplementalSemanticIds, this.qualifiers);
	}
	...
	public String toString() {
		return String.format("OpcNodeAnnotatedRelationshipElement (" + "annotations=%s," + ")", this.annotations);
	}
}
