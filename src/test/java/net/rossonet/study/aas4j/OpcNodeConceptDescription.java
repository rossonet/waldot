...
public class OpcNodeConceptDescription implements ConceptDescription {
    ...
    public OpcNodeConceptDescription() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeConceptDescription other = (OpcNodeConceptDescription) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeConceptDescription (" + "isCaseOf=%s,"
                + ")",
            this.isCaseOf);
    }

    /**
     * This builder class can be used to construct a OpcNodeConceptDescription bean.
     */
    public static class Builder extends ConceptDescriptionBuilder<OpcNodeConceptDescription, Builder> {
        ...
        @Override
        protected OpcNodeConceptDescription newBuildingInstance() {
            return new OpcNodeConceptDescription();
        }
    }
}
