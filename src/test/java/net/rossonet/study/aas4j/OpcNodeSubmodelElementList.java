...
public class OpcNodeSubmodelElementList implements SubmodelElementList {
    ...
    public OpcNodeSubmodelElementList() {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeSubmodelElementList other = (OpcNodeSubmodelElementList) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeSubmodelElementList (" + "orderRelevant=%s,"
                + "semanticIdListElement=%s,"
                + "typeValueListElement=%s,"
                + "valueTypeListElement=%s,"
                + "value=%s,"
                + ")",
            this.orderRelevant, this.semanticIdListElement, this.typeValueListElement, this.valueTypeListElement, this.value);
    }

    /**
     * This builder class can be used to construct a OpcNodeSubmodelElementList bean.
     */
    public static class Builder extends SubmodelElementListBuilder<OpcNodeSubmodelElementList, Builder> {
        ...
        @Override
        protected OpcNodeSubmodelElementList newBuildingInstance() {
            return new OpcNodeSubmodelElementList();
        }
    }
}
