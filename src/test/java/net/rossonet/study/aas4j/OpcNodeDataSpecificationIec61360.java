 ...
 * 
 * Content of data specification template for concept descriptions for
 * properties, values and value lists conformant to IEC 61360.
 */

@IRI("aas:DataSpecificationIec61360")
public class OpcNodeDataSpecificationIec61360 implements DataSpecificationIec61360 {

	/**
	 * This builder class can be used to construct a
	 * OpcNodeDataSpecificationIec61360 bean.
	 */
	public static class Builder extends DataSpecificationIec61360Builder<OpcNodeDataSpecificationIec61360, Builder> {
		...
		@Override
		protected OpcNodeDataSpecificationIec61360 newBuildingInstance() {
			return new OpcNodeDataSpecificationIec61360();
		}
	}
	...
	public OpcNodeDataSpecificationIec61360() {
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeDataSpecificationIec61360 other = (OpcNodeDataSpecificationIec61360) obj;
			return Objects.equals(this.preferredName, other.preferredName)
					&& Objects.equals(this.shortName, other.shortName) && Objects.equals(this.unit, other.unit)
					&& Objects.equals(this.unitId, other.unitId)
					&& Objects.equals(this.sourceOfDefinition, other.sourceOfDefinition)
					&& Objects.equals(this.symbol, other.symbol) && Objects.equals(this.dataType, other.dataType)
					&& Objects.equals(this.definition, other.definition)
					&& Objects.equals(this.valueFormat, other.valueFormat)
					&& Objects.equals(this.valueList, other.valueList) && Objects.equals(this.value, other.value)
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.preferredName, this.shortName, this.unit, this.unitId, this.sourceOfDefinition,
				this.symbol, this.dataType, this.definition, this.valueFormat, this.valueList, this.value,
				this.levelType);
	}
	...
	public String toString() {
		return String.format(
				"OpcNodeDataSpecificationIec61360 (" + "preferredName=%s," + "shortName=%s," + "unit=%s," + "unitId=%s,"
						+ "sourceOfDefinition=%s," + "symbol=%s," + "dataType=%s," + "definition=%s,"
						+ "valueFormat=%s," + "valueList=%s," + "value=%s," + "levelType=%s," + ")",
				this.preferredName, this.shortName, this.unit, this.unitId, this.sourceOfDefinition, this.symbol,
				this.dataType, this.definition, this.valueFormat, this.valueList, this.value, this.levelType);
	}
}
