...
@IRI("aas:Property")
public class OpcNodeProperty implements Property {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeProperty other = (OpcNodeProperty) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeProperty bean.
     */
    public static class Builder extends PropertyBuilder<OpcNodeProperty, Builder> {
        ...
        @Override
        protected OpcNodeProperty newBuildingInstance() {
            return new OpcNodeProperty();
        }
    }
}
