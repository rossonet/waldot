...
@IRI("aas:Reference")
public class OpcNodeReference implements Reference {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeReference other = (OpcNodeReference) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeReference bean.
     */
    public static class Builder extends ReferenceBuilder<OpcNodeReference, Builder> {
        ...
        @Override
        protected OpcNodeReference newBuildingInstance() {
            return new OpcNodeReference();
        }
    }
}
