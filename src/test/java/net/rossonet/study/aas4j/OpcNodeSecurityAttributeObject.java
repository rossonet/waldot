...
public class OpcNodeSecurityAttributeObject implements SecurityAttributeObject {
    ...
    public OpcNodeSecurityAttributeObject() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeSecurityAttributeObject other = (OpcNodeSecurityAttributeObject) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeSecurityAttributeObject (" + "type=%s,"
                + "key=%s,"
                + "value=%s,"
                + ")",
    ...
    /**
     * This builder class can be used to construct a OpcNodeSecurityAttributeObject bean.
     */
    public static class Builder extends SecurityAttributeObjectBuilder<OpcNodeSecurityAttributeObject, Builder> {
        ...
        @Override
        protected OpcNodeSecurityAttributeObject newBuildingInstance() {
            return new OpcNodeSecurityAttributeObject();
        }
    }
}
