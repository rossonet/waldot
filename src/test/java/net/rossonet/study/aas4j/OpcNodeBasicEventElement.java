...
public class OpcNodeBasicEventElement implements BasicEventElement {
    ...
    public OpcNodeBasicEventElement() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeBasicEventElement other = (OpcNodeBasicEventElement) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeBasicEventElement (" + "observed=%s,"
                + "direction=%s,"
                + "state=%s,"
                + "messageTopic=%s,"
                + "messageBroker=%s,"
    ...
    /**
     * This builder class can be used to construct a OpcNodeBasicEventElement bean.
     */
    public static class Builder extends BasicEventElementBuilder<OpcNodeBasicEventElement, Builder> {
        ...
        @Override
        protected OpcNodeBasicEventElement newBuildingInstance() {
            return new OpcNodeBasicEventElement();
        }
    }
}
