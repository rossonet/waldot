...
@IRI("aas:Blob")
public class OpcNodeBlob implements Blob {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeBlob other = (OpcNodeBlob) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeBlob bean.
     */
    public static class Builder extends BlobBuilder<OpcNodeBlob, Builder> {
        ...
        @Override
        protected OpcNodeBlob newBuildingInstance() {
            return new OpcNodeBlob();
        }
    }
}
