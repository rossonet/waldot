...
public class OpcVertexProperty<DATA_TYPE> extends UaVariableNode implements VertexProperty<DATA_TYPE> {

	private final Logger logger = LoggerFactory.getLogger(getClass());
	private final AbstractOpcGraph graph;
	private final boolean allowNullPropertyValues;

	public OpcVertexProperty(AbstractOpcGraph graph, final OpcVertex vertex, final String key, final DATA_TYPE value,
	...
	private OpcVertex getVertexPropertyReference() {
