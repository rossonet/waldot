...
public final class OpcGraphComputerView {
	...
	public OpcGraphComputerView(final AbstractOpcGraph graph, final GraphFilter graphFilter,
	...
	public <V> VertexProperty<V> addProperty(OpcVertex opcVertex, String key, V value) {
	...
	public List<Property> getProperties(final OpcVertex vertex) {
		final List<Property> list = new ArrayList<>();
		for (final OpcVertexProperty properties : getPropertiesMap(vertex).values()) {
			list.add(properties);
		}
	...
	private Map<String, OpcVertexProperty> getPropertiesMap(final OpcVertex vertex) {
		final Map<String, OpcVertexProperty> propertiesMap = vertex.getVertexProperties();
	...
	public List<VertexProperty<?>> getProperty(final OpcVertex vertex, final String key) {
	...
	public void removeProperty(final OpcVertex vertex, final String key, final VertexProperty property) {
		if (isComputeKey(key)) {
