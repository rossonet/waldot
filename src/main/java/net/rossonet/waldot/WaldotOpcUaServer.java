...
import net.rossonet.waldot.auth.WaldotAnonymousValidator;
import net.rossonet.waldot.auth.WaldotIdentityValidator;
import net.rossonet.waldot.auth.WaldotX509IdentityValidator;
...
public class WaldotOpcUaServer implements AutoCloseable {
	...
	public WaldotOpcUaServer(HomunculusConfiguration configuration, OpcUaConfiguration serverConfiguration) {
		try {
			server = create(serverConfiguration);
	...
	private OpcUaServer create(OpcUaConfiguration configuration) throws Exception {
		...
		final IdentityValidator<String> anonymousValidator = new WaldotAnonymousValidator(this);
		final UsernameIdentityValidator identityValidator = new WaldotIdentityValidator(this);
		final X509IdentityValidator x509IdentityValidator = new WaldotX509IdentityValidator(this);
	...
	private OpcUaServer generateServerInstance(OpcUaConfiguration configuration,
	...
	public OpcUaConfiguration getConfiguration() {
