...
public class JexlExecutorHelper implements ExecutorHelper {
	...
	public boolean evaluateRule(HomunculusNamespace waldotNamespace, EvaluationType evaluationType, UaNode node,
	...
	public Object executeRule(HomunculusNamespace waldotNamespace, EvaluationType attribute, UaNode node,
			AttributeId attributeId, Object value) {
		// TODO Auto-generated method stub
		return null;
	}
