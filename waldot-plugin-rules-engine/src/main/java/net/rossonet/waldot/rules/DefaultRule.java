...
public class DefaultRule extends AbstractOpcVertex implements Rule {
	...
	@Override
	public Object clone() {
		return new DefaultRule(typeDefinition, graph, getNodeContext(), getNodeId(), getBrowseName(), getDisplayName(),
				getDescription(), getWriteMask(), getUserWriteMask(), getEventNotifier(), version(), waldotRulesEngine,
				condition, action, priority, factsValidUntilMs, factsValidDelayMs);
	}
