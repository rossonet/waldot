...
package net.rossonet.waldot.rules.btree.decorator;

import net.rossonet.waldot.rules.btree.Decorator;
...
import net.rossonet.waldot.rules.btree.utils.BehaviorTreeLibraryManager;
...
public class Include<E> extends Decorator<E> {
	...
	/**
	 * Returns a clone of the referenced subtree if this {@code Import} is eager;
	...
	/**
	 * Copies this {@code Include} to the given task. A {@link TaskCloneException}
	 * is thrown if this {@code Include} is eager.
	 * 
