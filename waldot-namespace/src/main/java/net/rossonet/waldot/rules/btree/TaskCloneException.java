...
/**
 * A {@code TaskCloneException} is thrown when an exception occurs during task
 * cloning. See {@link Task#cloneTask()}
 * 
 * @author davebaol
 */
...
public class TaskCloneException extends RuntimeException {
	...
	/**
	 * Constructs a new {@code TaskCloneException} with null as its detail message.
	...
	/**
	 * Constructs a new {@code TaskCloneException} with the specified detail
	...
	/**
	 * Constructs a new {@code TaskCloneException} with the specified detail message
	 * and cause.
	 * <p>
	...
	/**
	 * Constructs a new {@code TaskCloneException} with the specified cause and a
