...
import net.rossonet.waldot.rules.utils.random.ConstantDoubleDistribution;
import net.rossonet.waldot.rules.utils.random.ConstantFloatDistribution;
import net.rossonet.waldot.rules.utils.random.ConstantIntegerDistribution;
import net.rossonet.waldot.rules.utils.random.ConstantLongDistribution;
import net.rossonet.waldot.rules.utils.random.Distribution;
import net.rossonet.waldot.rules.utils.random.DoubleDistribution;
import net.rossonet.waldot.rules.utils.random.FloatDistribution;
import net.rossonet.waldot.rules.utils.random.GaussianDoubleDistribution;
import net.rossonet.waldot.rules.utils.random.GaussianFloatDistribution;
import net.rossonet.waldot.rules.utils.random.IntegerDistribution;
import net.rossonet.waldot.rules.utils.random.LongDistribution;
import net.rossonet.waldot.rules.utils.random.TriangularDoubleDistribution;
import net.rossonet.waldot.rules.utils.random.TriangularFloatDistribution;
import net.rossonet.waldot.rules.utils.random.TriangularIntegerDistribution;
import net.rossonet.waldot.rules.utils.random.TriangularLongDistribution;
import net.rossonet.waldot.rules.utils.random.UniformDoubleDistribution;
import net.rossonet.waldot.rules.utils.random.UniformFloatDistribution;
import net.rossonet.waldot.rules.utils.random.UniformIntegerDistribution;
import net.rossonet.waldot.rules.utils.random.UniformLongDistribution;
...
public class DistributionAdapters {
	 ...
	 * one of the distribution types, but that the string does not have the
	 * appropriate format.
	 * 
	 * @author davebaol
	 */
	...
	public static class DistributionFormatException extends RuntimeException {
		...
		/**
		 * Constructs a <code>DistributionFormatException</code> with the specified
		 * detail message.
		 *
