 ...
 */
public class OpcDegreeCentralityFactory extends OpcServiceRegistry.OpcServiceFactory<Vertex,Long> implements Service<Vertex, Long> {
    ...
    public OpcDegreeCentralityFactory(final AbstractOpcGraph graph) {
        super(graph, NAME);
    }
