...
public abstract class TinkerWorld implements World {
	...
	/**
	 * The concrete {@link World} implementation for TinkerGraph that provides the
	...
	/**
	 * The {@link World} implementation for TinkerShuffleGraph that provides the
	 * {@link GraphTraversalSource} instances required by the Gherkin test suite.
	 */
	...
	/**
	 * The {@link World} implementation for TinkerTransactionGraph that provides the
	 * {@link GraphTraversalSource} instances required by the Gherkin test suite.
	 */
	...
	/**
	 * Get an instance of the underlying AbstractTinkerGraph with the provided
	 * configuration.
	 */
