...
public class OpcNodeLangStringNameType implements LangStringNameType {
    ...
    public OpcNodeLangStringNameType() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeLangStringNameType other = (OpcNodeLangStringNameType) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeLangStringNameType bean.
     */
    public static class Builder extends LangStringNameTypeBuilder<OpcNodeLangStringNameType, Builder> {
        ...
        @Override
        protected OpcNodeLangStringNameType newBuildingInstance() {
            return new OpcNodeLangStringNameType();
        }
    }
}
