...
@IRI("aas:ValueList")
public class OpcNodeValueList implements ValueList {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeValueList other = (OpcNodeValueList) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeValueList (" + "valueReferencePairs=%s,"
                + ")",
            this.valueReferencePairs);
    }

    /**
     * This builder class can be used to construct a OpcNodeValueList bean.
     */
    public static class Builder extends ValueListBuilder<OpcNodeValueList, Builder> {
        ...
        @Override
        protected OpcNodeValueList newBuildingInstance() {
            return new OpcNodeValueList();
        }
    }
}
