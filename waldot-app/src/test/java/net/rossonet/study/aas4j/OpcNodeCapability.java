 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.Capability
 * 
...
@IRI("aas:Capability")
public class OpcNodeCapability implements Capability {

	/**
	 * This builder class can be used to construct a OpcNodeCapability bean.
	 */
	public static class Builder extends CapabilityBuilder<OpcNodeCapability, Builder> {
		...
		@Override
		protected OpcNodeCapability newBuildingInstance() {
			return new OpcNodeCapability();
		}
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeCapability other = (OpcNodeCapability) obj;
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.embeddedDataSpecifications, this.category, this.idShort, this.displayName,
	...
	public String toString() {
		return String.format("OpcNodeCapability (" + ")"
