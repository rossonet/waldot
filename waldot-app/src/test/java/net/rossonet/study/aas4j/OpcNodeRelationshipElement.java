...
public class OpcNodeRelationshipElement implements RelationshipElement {
    ...
    public OpcNodeRelationshipElement() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeRelationshipElement other = (OpcNodeRelationshipElement) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeRelationshipElement (" + "first=%s,"
                + "second=%s,"
                + ")",
    ...
    /**
     * This builder class can be used to construct a OpcNodeRelationshipElement bean.
     */
    public static class Builder extends RelationshipElementBuilder<OpcNodeRelationshipElement, Builder> {
        ...
        @Override
        protected OpcNodeRelationshipElement newBuildingInstance() {
            return new OpcNodeRelationshipElement();
        }
    }
}
