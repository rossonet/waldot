 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.OperationRequest
 * 
 */

@IRI("aas:OperationRequest")
public class OpcNodeOperationRequest implements OperationRequest {

	/**
	 * This builder class can be used to construct a OpcNodeOperationRequest bean.
	 */
	public static class Builder extends OperationRequestBuilder<OpcNodeOperationRequest, Builder> {
		...
		@Override
		protected OpcNodeOperationRequest newBuildingInstance() {
			return new OpcNodeOperationRequest();
		}
	}
	...
	public OpcNodeOperationRequest() {
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeOperationRequest other = (OpcNodeOperationRequest) obj;
	...
	public String toString() {
		return String.format(
				"OpcNodeOperationRequest (" + "inoutputArguments=%s," + "inputArguments=%s,"
