 ...
 * encapsulation of multiple named values. It has a fixed number of submodel
 * elements.
 */

@IRI("aas:SubmodelElementCollection")
public class OpcNodeSubmodelElementCollection implements SubmodelElementCollection {

	/**
	 * This builder class can be used to construct a
	 * OpcNodeSubmodelElementCollection bean.
	 */
	public static class Builder extends SubmodelElementCollectionBuilder<OpcNodeSubmodelElementCollection, Builder> {
		...
		@Override
		protected OpcNodeSubmodelElementCollection newBuildingInstance() {
			return new OpcNodeSubmodelElementCollection();
		}
	}
	...
	public OpcNodeSubmodelElementCollection() {
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeSubmodelElementCollection other = (OpcNodeSubmodelElementCollection) obj;
	...
	public String toString() {
		return String.format("OpcNodeSubmodelElementCollection (" + "value=%s," + ")", this.value);
	}
}
