...
@IRI("aas:Descriptor")
public class OpcNodeDescriptor implements Descriptor {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeDescriptor other = (OpcNodeDescriptor) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeDescriptor (" + "description=%s,"
                + "displayName=%s,"
                + "extensions=%s,"
                + ")",
    ...
    /**
     * This builder class can be used to construct a OpcNodeDescriptor bean.
     */
    public static class Builder extends DescriptorBuilder<OpcNodeDescriptor, Builder> {
        ...
        @Override
        protected OpcNodeDescriptor newBuildingInstance() {
            return new OpcNodeDescriptor();
        }
    }
}
