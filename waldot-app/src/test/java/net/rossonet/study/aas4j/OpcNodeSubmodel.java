 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.Submodel
 * 
 * A submodel defines a specific aspect of the asset represented by the AAS.
 */

@IRI("aas:Submodel")
public class OpcNodeSubmodel implements Submodel {

	/**
	 * This builder class can be used to construct a OpcNodeSubmodel bean.
	 */
	public static class Builder extends SubmodelBuilder<OpcNodeSubmodel, Builder> {
		...
		@Override
		protected OpcNodeSubmodel newBuildingInstance() {
			return new OpcNodeSubmodel();
		}
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeSubmodel other = (OpcNodeSubmodel) obj;
			return Objects.equals(this.submodelElements, other.submodelElements)
					...
					&& Objects.equals(this.administration, other.administration) && Objects.equals(this.id, other.id)
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.submodelElements, this.embeddedDataSpecifications, this.kind, this.semanticId,
				this.supplementalSemanticIds, this.administration, this.id, this.category, this.idShort,
				this.displayName, this.description, this.extensions, this.qualifiers);
	}
	...
	public String toString() {
		return String.format("OpcNodeSubmodel (" + "submodelElements=%s," + ")", this.submodelElements);
	}
}
