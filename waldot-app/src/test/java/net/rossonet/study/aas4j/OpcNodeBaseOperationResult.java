...
public class OpcNodeBaseOperationResult implements BaseOperationResult {
    ...
    public OpcNodeBaseOperationResult() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeBaseOperationResult other = (OpcNodeBaseOperationResult) obj;
    ...
    public String toString() {
        return String.format(
                "OpcNodeBaseOperationResult (" + "executionState=%s,"
                        + "messages=%s,"
                        + "success=%s,"
                        + ")",
    ...
    /**
     * This builder class can be used to construct a OpcNodeBaseOperationResult bean.
     */
    public static class Builder extends BaseOperationResultBuilder<OpcNodeBaseOperationResult, Builder> {
        ...
        @Override
        protected OpcNodeBaseOperationResult newBuildingInstance() {
            return new OpcNodeBaseOperationResult();
        }
    }
}
