...
public class OpcNodeOperationVariable implements OperationVariable {

    @IRI("https://admin-shell.io/aas/3/0/OperationVariable/value")
    protected SubmodelElement value;

    public OpcNodeOperationVariable() {}
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeOperationVariable other = (OpcNodeOperationVariable) obj;
    ...
    public String toString() {
        return String.format(
            "OpcNodeOperationVariable (" + "value=%s,"
                + ")",
            this.value);
    }

    /**
     * This builder class can be used to construct a OpcNodeOperationVariable bean.
     */
    public static class Builder extends OperationVariableBuilder<OpcNodeOperationVariable, Builder> {
        ...
        @Override
        protected OpcNodeOperationVariable newBuildingInstance() {
            return new OpcNodeOperationVariable();
        }
    }
}
