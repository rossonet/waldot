...
@IRI("aas:File")
public class OpcNodeFile implements File {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeFile other = (OpcNodeFile) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeFile bean.
     */
    public static class Builder extends FileBuilder<OpcNodeFile, Builder> {
        ...
        @Override
        protected OpcNodeFile newBuildingInstance() {
            return new OpcNodeFile();
        }
    }
}
