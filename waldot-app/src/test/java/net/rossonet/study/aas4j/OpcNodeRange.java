...
@IRI("aas:Range")
public class OpcNodeRange implements Range {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeRange other = (OpcNodeRange) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeRange bean.
     */
    public static class Builder extends RangeBuilder<OpcNodeRange, Builder> {
        ...
        @Override
        protected OpcNodeRange newBuildingInstance() {
            return new OpcNodeRange();
        }
    }
}
