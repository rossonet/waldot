...
@IRI("aas:LevelType")
public class OpcNodeLevelType implements LevelType {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeLevelType other = (OpcNodeLevelType) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeLevelType bean.
     */
    public static class Builder extends LevelTypeBuilder<OpcNodeLevelType, Builder> {
        ...
        @Override
        protected OpcNodeLevelType newBuildingInstance() {
            return new OpcNodeLevelType();
        }
    }
}
