...
@IRI("aas:Entity")
public class OpcNodeEntity implements Entity {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeEntity other = (OpcNodeEntity) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeEntity bean.
     */
    public static class Builder extends EntityBuilder<OpcNodeEntity, Builder> {
        ...
        @Override
        protected OpcNodeEntity newBuildingInstance() {
            return new OpcNodeEntity();
        }
    }
}
