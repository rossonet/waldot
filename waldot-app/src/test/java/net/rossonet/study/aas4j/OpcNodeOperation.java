 ...
 * org.eclipse.digitaltwin.aas4j.v3.model.Operation
 * 
 * An operation is a submodel element with input and output variables.
 */

@IRI("aas:Operation")
public class OpcNodeOperation implements Operation {

	/**
	 * This builder class can be used to construct a OpcNodeOperation bean.
	 */
	public static class Builder extends OperationBuilder<OpcNodeOperation, Builder> {
		...
		@Override
		protected OpcNodeOperation newBuildingInstance() {
			return new OpcNodeOperation();
		}
	}
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			...
			final OpcNodeOperation other = (OpcNodeOperation) obj;
	...
	@Override
	public int hashCode() {
		return Objects.hash(this.inputVariables, this.outputVariables, this.inoutputVariables,
				this.embeddedDataSpecifications, this.category, this.idShort, this.displayName, this.description,
				this.extensions, this.semanticId, this.supplementalSemanticIds, this.qualifiers);
	}
	...
	public String toString() {
		return String.format(
				"OpcNodeOperation (" + "inputVariables=%s," + "outputVariables=%s," + "inoutputVariables=%s," + ")",
