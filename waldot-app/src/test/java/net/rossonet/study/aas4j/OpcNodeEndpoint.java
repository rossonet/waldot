...
@IRI("aas:Endpoint")
public class OpcNodeEndpoint implements Endpoint {
    ...
    public boolean equals(Object obj) {
        if (this == obj) {
            ...
            OpcNodeEndpoint other = (OpcNodeEndpoint) obj;
    ...
    /**
     * This builder class can be used to construct a OpcNodeEndpoint bean.
     */
    public static class Builder extends EndpointBuilder<OpcNodeEndpoint, Builder> {
        ...
        @Override
        protected OpcNodeEndpoint newBuildingInstance() {
            return new OpcNodeEndpoint();
        }
    }
}
