package net.rossonet.waldot.vertex;
...
import net.rossonet.oshi.vertex.OshiStoreVertex;
...
public class OshiInternetProtocolStatsVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiInternetProtocolStatsVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
