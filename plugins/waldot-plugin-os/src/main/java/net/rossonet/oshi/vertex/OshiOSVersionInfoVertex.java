...
public class OshiOSVersionInfoVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiOSVersionInfoVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
