...
public class OshiDisplayVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiDisplayVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
