...
public class OshiCentralProcessorVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiCentralProcessorVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
