...
public class OshiGraphicsCardVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiGraphicsCardVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
