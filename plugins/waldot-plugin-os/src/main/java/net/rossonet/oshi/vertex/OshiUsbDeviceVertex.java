...
public class OshiUsbDeviceVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiUsbDeviceVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
