...
public class OshiSoundCardVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiSoundCardVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
