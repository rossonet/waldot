...
public class OshiNetworkIFVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiNetworkIFVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
