...
public class OshiHWDiskStoreVertex extends AbstractOpcVertex implements OshiStoreVertex, AutoCloseable {
	...
	public OshiHWDiskStoreVertex(final WaldotGraph graph, final UaNodeContext context, final NodeId nodeId,
